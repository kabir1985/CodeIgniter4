...
<form id="ProductBrandModal_Form" method='post' action="<?php echo site_url('/Brand/create') ?>">
...
<div class='modal fade' id='product_brand_edit_modal' tabindex='-1' role='dialog' aria-labelledby='product_brand_edit_modal' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="product_brand_edit_form" method='post' action="<?php echo site_url('/Brand/update') ?>">
                <div class='modal-header'>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('/Brand/delete') ?>" method="post">
                <div class="modal-footer">
