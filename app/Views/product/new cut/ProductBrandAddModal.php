<!-- Modal -->
<form id="ProductBrandModal_Form" method='post' action="<?php echo site_url('/product/brand/create') ?>">
    <div class='modal fade' id='ProductBrandAddModalID' tabindex='-1' role='dialog' aria-labelledby='ProductBrandAddModalID' aria-hidden='true'>
