                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm btn-edit" data-product_category_id="<?php echo $row['product_category_id'] ?>" data-category_name="<?php echo $row['category_name'] ?>">
                                            <i class="fa fa-edit"></i></a>

                                        <a href="#" class="btn btn-danger btn-sm btn-delete" data-delete_id="<?php echo $row['product_category_id'] ?>"><i class="fa fa-trash-o"></i></a>
...
<div class='modal fade' id='CategoryAdd' tabindex='-1' role='dialog' aria-labelledby='CategoryAdd' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="product_category_add_form" method='post' action="<?php echo site_url('/Category/create') ?>" class="was-validated">
...
<div class='modal fade' id='CategoryEditModal' tabindex='-1' role='dialog' aria-labelledby='CategoryEditModal' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="product_category_edit_form" method='post' action="<?php echo site_url('/Category/update') ?>">
                <div class='modal-header'>
                ...
                <div class='modal-body' id="#">
                    <input type='hidden' required class='form-control' name='product_category_id' id='product_category_id'>
                    <div class='form-row'>
                        <div class='form-group col-md-12'>
                            <label>Category Edit</label>
                            <input type='text' required class='form-control' name='category_name' id='category_name'>
                        </div>
                    </div>
                </div>
                <div class='modal-footer'>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('/category/delete') ?>" method="post">
                <div class="modal-footer">
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('#product_category_edit_form').submit(function(event) {
            event.preventDefault();
