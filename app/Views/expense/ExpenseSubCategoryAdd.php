...
<div class='app-title'>
    <div>
        <h1><i class='fa fa-th-list'></i> Expense Sub Category Section</h1>
        <!-- <p>Table to display analytical data effectively</p> -->
    </div>

    <!-- Button trigger modal -->
    <button type='button' class='btn btn-primary btn-sm' data-toggle='modal' data-target='#SubCategoryAdd'>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm btn-edit" data-expense_sub_category_id="<?php echo $row['expense_sub_category_id'] ?>" data-expense_sub_category_name="<?php echo $row['expense_sub_category_name'] ?>">
                                            <i class="fa fa-edit"></i></a>

                                        <a href="#" class="btn btn-danger btn-sm btn-delete" data-delete_id="<?php echo $row['expense_sub_category_id'] ?>"><i class="fa fa-trash-o"></i></a>
...
<div class='modal fade' id='SubCategoryAdd' tabindex='-1' role='dialog' aria-labelledby='SubCategoryAdd' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="expense_sub_category_add_form" method='post' action="<?php echo site_url('/Expensesubcategory/create') ?>" class="was-validated">
                ...
                <div class='modal-body'>
                    <div class='form-row'>
                        ...
                        <div class='form-group col-md-12'>
                            ...
                            <input required type='text' required class='form-control' name='expense_sub_category_name' id='expense_sub_category_name' placeholder='Expense Sub Category Name'>
...
<div class='modal fade' id='ExpenseSubCategoryEditModal' tabindex='-1' role='dialog' aria-labelledby='ExpenseSubCategoryEditModal' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="expense_sub_category_edit_form" method='post' action="<?php echo site_url('/Expensesubcategory/update') ?>">
                <div class='modal-header'>
                ...
                <div class='modal-body' id="#">
                    <input type='hidden' required class='form-control' id='expense_sub_category_id' name='expense_sub_category_id'>
                    <div class='form-row'>
                        <div class='form-group col-md-12'>
                            <label>Sub Category Edit</label>
                            <input type='text' required class='form-control' id='expense_sub_category_name_update' name='expense_sub_category_name_update'>
                        </div>
                    </div>
                </div>
                <div class='modal-footer'>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('/Expensesubcategory/delete') ?>" method="post">
                <div class="modal-footer">
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        $('#expense_sub_category_add_form').submit(function(event) {
        ...
        $('#expense_sub_category_edit_form').submit(function(event) {
            event.preventDefault();
        ...
        $('.btn-edit').on('click', function() {
            ...
            $('#expense_sub_category_id').val(expense_sub_category_id);
            $('#expense_sub_category_name_update').val(expense_sub_category_name);

            // Call Modal Edit
            $('#ExpenseSubCategoryEditModal').modal('show');
