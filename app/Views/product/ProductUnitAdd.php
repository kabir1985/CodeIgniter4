...
<div class='modal fade' id='UnitAdd' tabindex='-1' role='dialog' aria-labelledby='UnitAdd' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="NewProductUnit_Form" method='post' action="<?php echo site_url('/Unit/create') ?>">
...
<div class='modal fade' id='unit_edit_modal' tabindex='-1' role='dialog' aria-labelledby='unit_edit_modal' aria-hidden='true'>
    <div class='modal-dialog  modal-dialog-centered' role='document'>
        <div class='modal-content'>
            <form id="product_unit_edit_form" method='post' action="<?php echo site_url('/Unit/update') ?>">
                <div class='modal-header'>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('/Unit/delete') ?>" method="post">
                <div class="modal-footer">
...
<script type='text/javascript'>
    $(document).ready(function() {
        ...
        //////Product Unit submit into database start/////////////////////////////////
        ...
        $('#product_unit_edit_form').submit(function(event) {
            event.preventDefault();
