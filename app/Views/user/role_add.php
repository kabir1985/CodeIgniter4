                ...
                <div class='table-responsive'>
                    <table class='table table-hover table-bordered' id='sampleTable'>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php //echo $row['group_name'] ?>Casier</td>
                                    <td>Cashier short note</td>
                                    <td>
                ...
                <div class='modal-body'>
                  <div class='form-row'>
                            ...
                            <div class='form-group col-md-6'>
                                ...
                                <input  type='text' required class='form-control' name='product_group_name' required placeholder='Group Name'>
                            </div>
                    </div>
