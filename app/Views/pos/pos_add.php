		...
		<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="processSales" class="btn btn-primary">Save changes</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-5">
			<select id="customer" class="form-control select2">
				...
				<option value="permanent-customer">Permanent Customer</option>
			</select>
		</div>
	</div>
	...
	<div class="row mt-3">
		<div class="col-sm-7">
			...
			<div class="text-right">
				<button class="btn btn-primary text-uppercase" data-toggle="modal" data-target="#inVoiceAdd11111" id="productSale">Sale</button>
			</div>
		</div>
