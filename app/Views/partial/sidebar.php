...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li>
    <a class="app-menu__item" href="<?php echo site_url('customer');?>">
    ...
    <li>
    <a class="app-menu__item" href="<?php echo site_url('customer/add');?>">
    <i class="app-menu__icon fa fa-user-plus"></i>
    <span class="app-menu__label">Customer Collapseable Form</span>
    </a>
    </li>
